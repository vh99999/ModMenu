...
public class SystemScreen extends BaseResponsiveLodestoneScreen {
    ...
    private void refreshList() {
        ...
        for (int i = 0; i < attributes.size(); i++) {
            ...
            list.addElement(new AttributeRowComponent(0, i * rowHeight, list.getWidth() - 10, rowHeight - 5, data.id, data.name, data.bonus));
        }
        list.setContentHeight(attributes.size() * rowHeight);
