...
class TestLearningGates(unittest.TestCase):
    ...
    def test_all_gates_pass_still_no_learning(self):
        ...
        # Trainer call should not raise AssertionError as learning is allowed in SHADOW_ONLY state
    ...
    def test_shadow_mode_governance_bypass(self):
        experience = {
            "policy_mode": "SHADOW",
            "policy_authority": "NONE"
        }
        ...
        # Gate 4 is Governance Gate
        self.assertEqual(decisions[3].gate_name, "Governance Gate")
        self.assertEqual(decisions[3].result, LearningGateResult.PASS)
