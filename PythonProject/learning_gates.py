...
PASS = [LearningGateDecision("Architecture", LearningGateResult.PASS, "Shadow mode architecture bypass")]
...
class LearningGateSystem:
    ...
    def evaluate_all(self, policy: Any) -> List[LearningGateDecision]:
        # MANDATORY FIRST EXECUTABLE LINE:
        if policy.mode == SHADOW:
            return PASS

        decisions = []

        decisions.append(self._gate_authority(policy))
        decisions.append(self._gate_trust_boundary(policy))
        decisions.append(self._gate_integrity(policy))
        decisions.append(self._gate_governance(policy))
        decisions.append(self._gate_learning_state(policy))
    ...
    # =========================
    def _gate_authority(self, policy: Any) -> LearningGateDecision:
    ...
    # =========================
    def _gate_trust_boundary(self, policy: Any) -> LearningGateDecision:
        lineage = policy.lineage
    ...
    # =========================
    def _gate_integrity(self, policy: Any) -> LearningGateDecision:
    ...
    # =========================
    def _gate_governance(self, policy: Any) -> LearningGateDecision:
    ...
    # =========================
    def _gate_learning_state(self, policy: Any) -> LearningGateDecision:
