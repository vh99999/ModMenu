...
class TestExternalConnectivity(unittest.TestCase):
    ...
    def test_live_payload_reaches_inference_unchanged(self):
        ...
        self.assertEqual(response["learning_state"], "FROZEN")
    ...
    def test_learning_remains_frozen_under_spoofing(self):
        ...
        # Even with spoofed flags, learning MUST remain frozen.
        self.assertEqual(response["learning_state"], "FROZEN")
